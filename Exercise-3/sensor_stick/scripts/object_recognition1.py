...
# Exercise-2 TODOs:
    ...
    pcl_objects = cloud_filtered
    pcl.save(cloud_filtered, 'cloud_filtered1.pcd')
...
if __name__ == '__main__':
    ...
    pcl1_sub = rospy.Subscriber("/pr2/world/points", pc2.PointCloud2, pcl_callback, queue_size=10)
